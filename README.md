...
To reset a local environment to exactly one System Admin account, set the
`DEV_ADMIN_*` variables and run `npm run seed:dev`. This deletes all existing
local application data; see `docs/local-admin-seed.md`.
